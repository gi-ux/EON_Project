...
s.t. decimo_vincolo{(k1,k2) in K1K2}: w[k1,k2] <= f[k1] - f[k2] - sum{m in M} B * b_star[m,k2] - G + S * (1-d[k1,k2]);

s.t. undicesimo_vincolo{(k1,k2) in K1K2}: w[k1,k2] <= f[2] - f[k1] - sum{m in M} B * b_star[m,k1] - G + S * d[k1,k2];